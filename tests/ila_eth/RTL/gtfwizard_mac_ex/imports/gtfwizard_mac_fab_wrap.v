...
IBUFDS_GTE4 #(
  ...
  wire              gtf_ch_gtrefclk0 = refclk_in; // Rewire to use rx clock //gtf_ch_gtrefclk0 = refclk_in;
  ...
  wire              gtf_cm_gtrefclk00 = refclk_in; // Rewire to use rx clock // gtf_cm_gtrefclk00 = refclk_in;
...
endgenerate
  ...
  wire [NUM_CHANNEL-1:0]             gtf_ch_txoutclk;
...
.gtf_ch_txoutclk                           (gtf_ch_txoutclk[i]                        ),
