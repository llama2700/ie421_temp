...
This section provides steps to run the GTF Recovery Clock Routing design on the UL3422 via the Vivado HW Manager.

The key steps to run the design are:

1. Program the device
 * Program the UL3422 with the bitstream (.bit) and ILA (.ltx).
