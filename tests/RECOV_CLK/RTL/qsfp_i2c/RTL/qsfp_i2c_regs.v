...
module qsfp_i2c_regs (
    ...
    output reg  [0:0] IO_CONTROL_RESETN_MUX,
...
localparam ADDR_CONTROL_RESETN_MUX = 'h00000014;
localparam DFLT_CONTROL_RESETN_MUX = 'h00000000;
...
begin
    if (!sys_if_rstn)
        IO_CONTROL_RESETN_MUX <= DFLT_CONTROL_RESETN_MUX;
    else if ( (sys_if_addr == ADDR_CONTROL_RESETN_MUX) && sys_if_wen)
        IO_CONTROL_RESETN_MUX <= sys_if_wdata[2:2];
end
...
begin
    ...
    RDATA_CONTROL[2:2] = IO_CONTROL_RESETN_MUX;
